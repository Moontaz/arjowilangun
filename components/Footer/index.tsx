      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-1.5 mt-20 text-sectiontitle uppercase tracking-[5px]">
                  contact
                </p>
                <a className="text-base font-medium text-black dark:text-white">
                  082230595287
                </a>
                <br />
                <a
                  href="mailto:mertowijoyomakmur@gmail.com"
                  className="text-base font-medium text-black dark:text-white"
                >
                  mertowijoyomakmur@gmail.com
                </a>
              </motion.div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Moongo. All rights reserved
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a
                    href="https://www.facebook.com/desarjowilangun"
                ...
                <li>
                  <a
                    href="https://x.com/arjowilangun1"
                    aria-label="social icon"
                  >
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
